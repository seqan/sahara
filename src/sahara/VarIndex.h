...
struct VarIndex {
    ...
    using Vs = std::variant<
        ...
        typename fmc::BiFMIndex<Sigma, fmc::string::InterleavedBitvectorPrefix16, SparseArray<std::tuple<uint32_t, uint32_t>>>::NoDelim,
        ...
        fmc::BiFMIndex<Sigma, fmc::string::InterleavedBitvectorPrefix16, SparseArray<std::tuple<uint32_t, uint32_t, bool>>>,
        ...
        typename fmc::BiFMIndex<Sigma, fmc::string::InterleavedBitvectorPrefix16, SparseArray<std::tuple<uint32_t, uint32_t, bool>>>::NoDelim,
        ...
        typename fmc::BiFMIndexKStep<Sigma, fmc::string::InterleavedBitvectorPrefix16, SparseArray<std::tuple<uint32_t, uint32_t>>>::template SetKStep<2>,
        ...
        typename fmc::BiFMIndexKStep<Sigma, fmc::string::InterleavedBitvectorPrefix16, SparseArray<std::tuple<uint32_t, uint32_t>>>::template SetKStep<4>,
        ...
        typename fmc::BiFMIndexKStep<Sigma, fmc::string::InterleavedBitvectorPrefix16, SparseArray<std::tuple<uint32_t, uint32_t>>>::NoDelim::template SetKStep<2>,
        ...
        typename fmc::BiFMIndexKStep<Sigma, fmc::string::InterleavedBitvectorPrefix16, SparseArray<std::tuple<uint32_t, uint32_t>>>::NoDelim::template SetKStep<3>,
        ...
        typename fmc::BiFMIndexKStep<Sigma, fmc::string::InterleavedBitvectorPrefix16, SparseArray<std::tuple<uint32_t, uint32_t>>>::NoDelim::template SetKStep<4>,
